...
def shared_tokenizer(parser, default_value=None):
    # this uses RecordArgument, bc the tokenizer definition is being shared
    # it is not important to understand this part.
    #
    # this could also being done by directly implemented in the main.py without the RecordArgument
    parser.add_argument('--tokenizer.minL',
                                    #dest="minL",
                                    type=int, 
    ...
    parser.add_argument('--tokenizer.stopwords_path',
                                    #dest="stopwords_path",
                                    type=str,
                                    action=RecordArgument,
                                    default=None,
    ...
    parser.add_argument('--tokenizer.stemmer',
                                    #dest="stemmer",
                                    type=str, 
                                    action=RecordArgument,
                                    default=None,
    ...
    parser.add_argument('--tokenizer.regular_exp',
                                    #dest="stemmer",
                                    type=str, 
                                    action=RecordArgument,
                                    default=None,
    ...
    parser.add_argument('--tokenizer.lowercase',
                                    #dest="stemmer",
                                    type=str, 
                                    action=RecordArgument,
                                    default=None,
